...
set(DELAY_DLL_NAMES_DEBUG opencv_core4140d.dll opencv_imgproc4140d.dll ${DELAY_DLL_NAMES})

set(DELAY_DLL_NAMES_RELEASE opencv_core4140.dll opencv_imgproc4140.dll quazip1-qt6.dll ${DELAY_DLL_NAMES})
...
file(COPY ${OpenCV_DIR}/bin/Release/opencv_core4140.dll DESTINATION ${CMAKE_BINARY_DIR}/Release/)
file(COPY ${OpenCV_DIR}/bin/Release/opencv_imgproc4140.dll DESTINATION ${CMAKE_BINARY_DIR}/Release/)
if(ENABLE_QUAZIP)
